...
class ProductManager {
    ...
    writeFileProducts() {
        fs.writeFile('DB/products.json', JSON.stringify(this.products),
            (err) => {
                if (err) throw err;
    ...
    deleteProduct(id) {
        ...
        this.products.map((product) => {
            ...
            fs.writeFile('DB/products.json', JSON.stringify(arrayVacio),
                (err) => {
                    if (err) throw err;
...
// console.log('productos agreagados...', gestionProd.readFileProducts())

const productosxd = gestionProd.readFileProducts()
console.log('productos extraidos en al constante productos xd', productosxd)
